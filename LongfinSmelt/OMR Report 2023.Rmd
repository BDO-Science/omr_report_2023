...
#20-mm survey needs to be an average of the 3 tows - since this doesn't include 0 data and we don't have that yet, we will assume tows 1 and 3 were completed and had 0 LFS. Right now there is only on 20-mm survey station included in this plot. Updated data may change this and should include accurate 0 data in case certain tows were missed, etc. For now though I'm just going to make a manual change.

csd.stat$Count[csd.stat$SurveyType == "20-mm"] <- 0.33
